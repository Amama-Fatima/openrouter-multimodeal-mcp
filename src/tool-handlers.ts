...
import {
  handleSearchModels,
  SearchModelsToolRequest,
} from "./tool-handlers/search-models.js";
import {
  handleGetModelInfo,
  GetModelInfoToolRequest,
} from "./tool-handlers/get-model-info.js";
import {
  handleValidateModel,
  ValidateModelToolRequest,
} from "./tool-handlers/validate-model.js";
import {
  handleMultiImageAnalysis,
  MultiImageAnalysisToolRequest,
} from "./tool-handlers/multi-image-analysis.js";
import {
  handleAnalyzeImage,
  AnalyzeImageToolRequest,
} from "./tool-handlers/analyze-image.js";
import {
  handleGenerateImage,
  ...
  private setupToolHandlers() {
    this.server.setRequestHandler(ListToolsRequestSchema, async () => ({
      tools: [
          ...
          inputSchema: {
            ...
            properties: {
              model: {
                type: "string",
                description:
                  'The model to use (e.g., "google/gemini-2.5-pro-exp-03-25:free", "undi95/toppy-m-7b:free"). If not provided, uses the default model if set.',
              },
              messages: {
                type: "array",
                description:
                    ...
                    content: {
                      oneOf: [
                        ...
                        },
                        {
                          type: "array",
                          description:
                            "Array of content parts for multimodal messages (text and images)",
                          items: {
                            type: "object",
                            properties: {
                              type: {
                              ...
                              image_url: {
                                type: "object",
                                description:
                                  "The image URL object (for image_url type)",
                                properties: {
                                  url: {
                                    type: "string",
                                    description:
                                      "URL of the image (can be a data URL with base64)",
                                  },
                                },
                                required: ["url"],
                              },
        ...
        // Generate Image Tool
        {
          name: "mcp_openrouter_generate_image",
          description:
          ...
          inputSchema: {
            ...
            properties: {
              prompt: {
                type: "string",
                description:
                  "The text prompt describing the image to generate. Be detailed and specific for best results.",
              },
              model: {
                type: "string",
                description:
                  'The model to use for image generation (default: "google/gemini-2.5-flash-image-preview"). Must be a model with image generation capabilities.',
              },
              aspect_ratio: {
                type: "string",
                enum: [
                ...
                description:
                  "Aspect ratio for the generated image (Gemini models only). Default is 1:1 (1024x1024).",
              },
              n: {
                type: "number",
                description:
                  "Number of images to generate (default: 1). Note: some models may not support multiple images.",
                minimum: 1,
                maximum: 4,
              },
          ...
          inputSchema: {
            ...
            properties: {
              ...
              model: {
                type: "string",
                description:
                  'OpenRouter model to use (e.g., "anthropic/claude-3.5-sonnet")',
              },
            },
            required: ["image_path"],
          },
          ...
          inputSchema: {
            ...
            properties: {
                ...
                items: {
                  ...
                  properties: {
                    url: {
                      type: "string",
                      description:
                        "URL or data URL of the image (use http(s):// for web images, absolute file paths for local files, or data:image/xxx;base64,... for base64 encoded images)",
                    },
                    alt: {
                      type: "string",
                      description:
                        "Optional alt text or description of the image",
                    },
                  },
                  required: ["url"],
                },
              ...
              markdown_response: {
                type: "boolean",
                description:
                  "Whether to format the response in Markdown (default: true)",
                default: true,
              },
              model: {
                type: "string",
                description:
                  "OpenRouter model to use. If not specified, the system will use a free model with vision capabilities or the default model.",
              },
            },
    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
      switch (request.params.name) {
          ...
          return handleChatCompletion(
            {
              params: {
                arguments: request.params
                  .arguments as unknown as ChatCompletionToolRequest,
              },
            },
            this.openai,
            this.defaultModel
        ...
        case "mcp_openrouter_generate_image":
          return handleGenerateImage(
            {
              params: {
                arguments: request.params
                  .arguments as unknown as GenerateImageToolRequest,
              },
            },
            this.openai,
            this.defaultModel
          ...
          return handleAnalyzeImage(
            {
              params: {
                arguments: request.params
                  .arguments as unknown as AnalyzeImageToolRequest,
              },
            },
            this.openai,
            this.defaultModel
          ...
          return handleMultiImageAnalysis(
            {
              params: {
                arguments: request.params
                  .arguments as unknown as MultiImageAnalysisToolRequest,
              },
            },
            this.openai,
            this.defaultModel
          ...
          return handleGetModelInfo(
            {
              params: {
                arguments: request.params
                  .arguments as unknown as GetModelInfoToolRequest,
              },
            },
            this.modelCache
          );
          ...
          return handleValidateModel(
            {
              params: {
                arguments: request.params
                  .arguments as unknown as ValidateModelToolRequest,
              },
            },
            this.modelCache
          );
